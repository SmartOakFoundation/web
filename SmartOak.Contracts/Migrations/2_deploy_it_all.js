...
var SmartOakToken = artifacts.require("./SmartOakToken.sol");
var SmartOakCompany = artifacts.require("./SmartOakCompany.sol");
var SmartOakStore = artifacts.require("./SmartOakStore.sol");
...
module.exports = function (deployer, network, accounts) {
    ...
    var scriptToRun = new Promise((res, rej) => {
        contractFactory(NameRegistry, 'reg')
            .then(function () { return contractFactory(SmartOakToken, 'SmartOakToken', data.reg.address); })
            .then(function () { return contractFactory(SmartOakStore, 'GamesStore', data.reg.address); })
            .then(function () {
                return contractFactory(SmartOakCompany, 'SmartOakCompany', data.reg.address, addr.governor1, addr.governor2, addr.governor3)
            })
            ...
            .then(function () { return changeOwner("Game store", data.GamesStore, data.SmartOakCompany.address); })
            .then(function () { return changeOwner("SmartOak Company", data.SmartOakCompany, data.SmartOakCompany.address); })
            .then(function () { return changeOwner("SmartOak Token",data.SmartOakToken, data.SmartOakCompany.address); })
            .then(function () {
