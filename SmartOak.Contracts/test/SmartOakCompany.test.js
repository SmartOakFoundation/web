...
contract('SmartOakCompany', function (accounts) {
    var data = {};
    ...
    beforeEach(async function () {
        ...
        data.company = await SmartOakCompany.new(data.nameRegistry.address,  accounts[1], accounts[2], accounts[3]);
    ...
    describe('SmartOakCompany base test', function () {
