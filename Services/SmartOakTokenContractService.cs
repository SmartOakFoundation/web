...
{
    public class SmartOakTokenContractService : BaseContractService
    {

        public SmartOakTokenContractService(
            IMemoryCache _cache,
        ...
        {
            abi = AbiReader.Read("SmartOakToken.json");
            contract = web3.Eth.GetContract(abi, nameRegistry.Addresses["SmartOakToken"]);
        }
    }
