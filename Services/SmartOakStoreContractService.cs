...
{
    public class SmartOakStoreContractService : BaseContractService
    {
        public uint MULTI_KEY_MARK = ((uint)Math.Pow(2, 32)) - 1;
        public SmartOakStoreContractService(
            IMemoryCache _cache,
        ...
        {
            abi = AbiReader.Read("SmartOakStore.json");
            contract = web3.Eth.GetContract(abi, nameRegistry.Addresses["SmartOakStore"]);
        }
    }
