...
using SmartOak.Web.Controllers;
using System;
...
namespace SmartOak.Web.Services
{
    public class GamesPurchaseeUpdater : IHostedService, IDisposable
    {
        ...
        private SmartOakStoreContractService _store;
        ...
        {
            _store = (SmartOakStoreContractService)Startup.ServiceProvider.GetService(typeof(SmartOakStoreContractService));
