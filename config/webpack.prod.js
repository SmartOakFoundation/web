...
module.exports = {
    ...
    plugins: [
        ...
        new CleanWebpackPlugin(['./wwwroot/dist', './wwwroot/img', './wwwroot/css', '/index.html', './wwwroot/data'], {
            root: ROOT
        }),
        ...
        new CopyWebpackPlugin([
            ...
            { from: './app/img/games/*.*', to: 'img/games', flatten: true },
            { from: './app/data/*.*', to: 'data/', flatten: true }
        ])
    ]
};
