...
namespace Pway.Web.Controllers
{
    ...
    public class GamesController : Controller
    {
        ...
        private readonly PwayGamesStoreContractService pwayGamesStore;
        private readonly ILogger<GamesController> logger;

        public GamesController(ApplicationDbContext dbContext,
            PwayGamesStoreContractService pwayGamesStoreContractService,
            ILogger<GamesController> logger)
        {
            this.dbContext = dbContext;
            this.pwayGamesStore = pwayGamesStoreContractService;
            this.logger = logger;
        }
        ...
        public async Task<JsonResult> GetSecretGameKeys(int id)
        {
            ...
            if (isUserValid())
            {
                ...
                do
                {
                    tmp = await pwayGamesStore.GetAccountGameLicenses(5,address, page);
